...
import com.microsoft.azure.msalwebsample.interceptor.Authorized;
...
public class AuthPageController {
	...
	@Authorized(hasRole = { "sales", "test" })
	public ModelAndView securePage(HttpServletRequest httpRequest, HttpServletResponse response) throws ParseException {
	...
	public ModelAndView getUsersFromGraph(HttpServletRequest httpRequest, HttpServletResponse response)
		...
		try {
			...
			if (e.getCause() instanceof MsalInteractionRequiredException) {
				...
				// If silent call returns MsalInteractionRequired, then redirect
				...
				String authorizationCodeUrl = authHelper.getAuthorizationCodeUrl(httpRequest.getParameter("claims"),
						"User.ReadBasic.all", authHelper.getRedirectUriGraphUsers(), state, nonce);
